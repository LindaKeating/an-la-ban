...
<div id="page" class="site">
  ...
  <header id="masthead" class="<?= apply_filters('bootscore/class/header', 'sticky-top bg-primary glb-header'); ?> site-header d-none d-md-block">
        ...
        <div class="offcanvas offcanvas-end" tabindex="-1" id="offcanvas-navbar">
          <div class="offcanvas-header">
            <span class="h5 offcanvas-title">
              <?= apply_filters('bootscore/offcanvas/navbar/title', __('Menu', 'bootscore')); ?>
            </span>
          </div>
          <div class="offcanvas-body glb-navbar">
