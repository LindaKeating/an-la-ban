...
/**
 * Register the icons NavWalker
 */
if (!function_exists('register_icon_navwalker')) :
  function register_icon_navwalker() {

    // https://github.com/AlexWebLab/bootstrap-5-wordpress-navbar-walker
    class icon_wp_nav_menu_walker extends Walker_Nav_menu {
      private $current_item;
      private $dropdown_menu_alignment_values = [
        'dropdown-menu-start',
        'dropdown-menu-end',
      ...
      function start_el(&$output, $item, $depth = 0, $args = null, $id = 0) {
        ...
        $item_output = $args->before;
        $item_output .= '<a' . $attributes . '><i class="fa-solid">';
...
add_action('after_setup_theme', 'register_icon_navwalker');